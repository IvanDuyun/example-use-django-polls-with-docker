"""
Django settings for test_for_polls project.
...
SECRET_KEY = 'django-insecure-!()yofz4(b-s+#sm-0jm)%_$a2s^=je%!9e0vr_*o^kuc1mm3o'
...
ROOT_URLCONF = 'test_for_polls.urls'
...
WSGI_APPLICATION = 'test_for_polls.wsgi.application'
